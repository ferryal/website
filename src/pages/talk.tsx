...
import {SiDiscord, SiTwitter, SiWhatsapp} from 'react-icons/si';
			...
			<div className="grid grid-cols-1 gap-4 md:grid-cols-2">
				<div>
					<form
						...
						onSubmit={async event => {
							...
							const promise = fetcher('https://alistair.sh/api/talk', {
					...
					>
						...
						<Turnstile
							...
							siteKey="0x4AAAAAAABzk1kq4hjKcRHC"
						/>
				...
				<div>
					<ul className="list-inside list-disc space-y-2 pt-5 md:float-right">
						<ListItemReversed icon={HiOutlineMail} text="ferryalmfajar@gmail.com" />
						<ListItemReversed
							icon={SiDiscord}
							text={
								lanyard ? (
						...
						/>
						<ListItemReversed icon={SiTwitter} text="iyalion" />
						<ListItemReversed icon={RiPhoneLine} text="+62 85156317566" />
						<ListItemReversed icon={SiWhatsapp} text="+62 81808319505" />
					</ul>
				</div>
			</div>
		</div>
