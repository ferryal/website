...
export default function Index(props: Props) {
	const {data: projects = props.pinnedRepos} = useGitHubPinnedRepos('ferryal');
		...
		<>
			<div className="space-y-4">
				...
				<h1 className="text-3xl font-bold sm:text-4xl md:text-6xl">
					Hey, I'm{' '}
					<span className="text-blue-700 dark:text-white">Ferryal Fajar</span> ✌️
				</h1>

				<p className="opacity-80">
					I'm a <span suppressHydrationWarning>~{age.toPrecision(7)}</span> year
					old software engineer from the Indonesia. I'm interested in full
			...
			<div className="space-y-4">
				...
				<p className="opacity-80">
					...
					<a href="https://www.dagangan.com/" target="_blank" rel="noreferrer">
						Dagangan
					</a>{' '}
...
export const getStaticProps: GetStaticProps<Props> = async function () {
	const pinnedRepos = await fetch(
		'https://gh-pinned.nxl.sh/api/user/ferryal',
